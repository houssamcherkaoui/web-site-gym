...
<section class="gallery-section spad">
    <div class="container">
        <div class="section-title text-center">
            ...
            <p>Take a look at our training moments and gym atmosphere!</p>
        </div>
        <div class="row">
            <!-- Photo 1 -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-item">
                    <img src="img/386365277_314569454598764_6847827122356702385_n.jpg" alt="Gym Image 1" class="img-fluid">
                </div>
            </div>
            <!-- Photo 2 -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-item">
                    <img src="img/386590323_629667202666061_6634898796707040855_n.jpg" alt="Gym Image 2" class="img-fluid">
                </div>
            </div>
            <!-- Photo 3 -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-item">
                    <img src="img/387265966_1371443950245634_8054193556468657415_n.jpg" alt="Gym Image 3" class="img-fluid">
                </div>
            </div>
            <!-- Photo 4 -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-item">
                    <img src="img/arena promo.jpg" alt="Gym Image 4" class="img-fluid">
                </div>
            </div>
            <!-- Photo 5 -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-item">
                    <img src="img/arena promo2.jpg" alt="Gym Image 5" class="img-fluid">
                </div>
            </div>
            <!-- Photo 6 -->
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="gallery-item">
                    <img src="img/promo arenaa 3.jpg" alt="Gym Image 6" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
