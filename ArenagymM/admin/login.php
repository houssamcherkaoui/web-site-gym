...
if(isset($_POST['submit'])) {
  ...
  $password = $_POST['password']; // mot de passe non crypté ici pour le test

  // accès direct avec email + mot de passe simple
  if($email == "admin@arena.com" && $password == "1234") {
    $_SESSION['adminid'] = 1;
    $_SESSION['email'] = $email;
    $_SESSION['name'] = "Admin Arena";
    header("location: index.php");
    exit();
  }

  // sinon, vérification en base de données
...
<html>
  <head>
    ...
    <title>ARENA || Admin login</title>
  </head>
  <body>
      <marquee onMouseOver="this.stop()" style="color: #e92f33;" onMouseOut="this.start()">arena site web <a target="_blank" href="https://www.youtube.com/@codecampbdofficial">welcom</a> to arena !</marquee>
	<!-- 
