 <header style="background-color:rgb(225, 255, 0);"  class="app-header"><a style="background-color:rgb(225, 255, 0);" class="app-header__logo" href="index.php">ARENA</a>
      <!-- Sidebar toggle button--><a style="background-color:rgb(221, 255, 0);" class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"></a>
      <!-- Navbar Right Menu-->
      <ul class="app-nav">
